...
// NOTE: the business-card avatars in public/images/contact/ were generated by
// this script at `maxSize: 288` (a 96 CSS px circle at 3x), but their
// full-resolution originals are not in the repo, so they have no entry here —
// listing a missing source makes the whole script exit(1). Drop the originals
// back into public/images/contact/ and re-add them here to regenerate.
const ENTRIES = [
