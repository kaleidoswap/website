...
- **Connecting your apps.** Nostr Wallet Connect lets the mobile app and browser extension talk to your own node running in the desktop app, instead of a middleman.
- **Login and zaps.** The browser extension signs you in with your Nostr identity, and lets you send zaps, which are instant Lightning tips.
- **Zaps to your name.** Receiving zaps on a kaleidoswap.me address is coming soon to the extension.
