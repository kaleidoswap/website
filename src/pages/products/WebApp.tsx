...
const features = [
  ...
  },
  {
    ...
    description: 'Works with Alby, Bitmask, and other WebLN wallets.',
  },
  {
    icon: Globe,
...
const supportedWallets = [
  ...
  { name: 'Xverse', status: 'coming-soon' },
]
...
export const WebApp = () => {
  ...
  return (
    <div className="min-h-screen bg-background-dark text-white font-display">
      <SEO
        title="Web App"
        description="Trade BTC, stablecoins, and RGB assets directly from your browser. No installation required. Connect your WebLN wallet and start swapping."
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                {t('The fastest way to swap. No download required. Connect your WebLN wallet and trade BTC, stablecoins, and RGB assets in seconds.')}
              </p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { step: '01', title: 'Connect Wallet', desc: 'Link your WebLN wallet (Alby, Bitmask)' },
