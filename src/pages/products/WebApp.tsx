    ...
    <div className="min-h-screen bg-transparent text-white font-display">
      ...
      {WEB_APP_LIVE && (
        <>
          ...
          {/* Supported Wallets */}
          <section id="supported-wallets" className="py-20 scroll-mt-24">
            <div className="max-w-7xl mx-auto px-6">
              <AnchorHeading id="supported-wallets" className="text-3xl font-bold text-center mb-12">
                {t('Supported Wallets')}
              </AnchorHeading>
          ...
          {/* CTA */}
          <section id="ready-to-swap" className="py-20 scroll-mt-24">
            <div className="max-w-4xl mx-auto px-6 text-center">
              <AnchorHeading id="ready-to-swap" className="text-3xl font-bold mb-4">
                {t('Ready to Swap?')}
              </AnchorHeading>
