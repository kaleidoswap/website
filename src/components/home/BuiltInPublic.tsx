import { ExternalLink, Zap, Handshake, Medal } from 'lucide-react'
                    ...
                    {backer.logo && (
                      <div className="w-12 shrink-0 flex items-center justify-center">
                        <img
                          src={backer.logo}
                          alt=""
                          className="h-12 w-12 object-contain object-center opacity-60 group-hover:opacity-80 transition-opacity"
                        />
                      </div>
                    )}
